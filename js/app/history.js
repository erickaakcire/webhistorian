  ...
  function svyEnd (data){ //i=1 because the end item is the second one in the config
    ...
    history.wir = function(weekData, online, url) {
        ...
        $("#wir").html( function() {
          ...
          var thanks = "<br/><br/><h3>Thank you for participating in our study!</h3><p>You are now able to view your uploaded data on the Web Historian server. This icon <span class='glyphicon glyphicon-export'></span> appears in your navigation to allow you to do so. You are able to see how you compare to other participants in your overall amount of browsing, the number of different websites your visit, and more.</p><p>For more information about the project see \"<a href=\" http://www.webhistorian.org/participate/\" target=\"_blank\">Understanding Access to Information Online and in Context\"</a>. For updates on reports and to participate in further studies <a href=\""+config.endSvyUrls[0]+"\" target=\"_blank\">click here to sign up</a>. Two months after your first data upload you will be asked for a follow-up contribution. </p>";
